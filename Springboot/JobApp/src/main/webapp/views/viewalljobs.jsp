...
<%@ page import="com.protector.JobApp.model.JobPost" %>
<%@ page import="com.protector.JobApp.repository.JobRepository" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Protector Job Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://protector.com/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
