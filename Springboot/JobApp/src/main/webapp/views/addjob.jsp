...
<%@ page isELIgnored="false"%>
	...
	<title>PROTECTOR Job Portal</title>
	<link
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-warning">
			<div class="container">
				<a class="navbar-brand fs-1 fw-medium" href="#">Protector Job
					Portal Web App</a>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item"><a class="nav-link" href="https://protector.com/">Contact</a>
						</li>
					</ul>
				</div>
			</div>
							...
							<form:form action="handleForm" method="post" modelAttribute="jobPost">
								...
								<div class="mb-2">
									...
									<select multiple class="form-select" id="postTechStack"
										...
										<option value="Dart">Flutter</option>
